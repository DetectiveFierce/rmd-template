...
\usepackage{xparse} % put this in your preamble
\NewDocumentEnvironment{proofline}{O{0.5ex} O{0mm}}{%
  \begin{list}{}{%
  ...
  \tcolorbox[
    ...
    parbox=false,
    overlay unbroken={%
      % Draw normal line for unbroken boxes
      \draw[black, line width=1pt]
        ([xshift=#1,yshift=-#2]frame.south west) -- 
        ([xshift=#1,yshift=#2]frame.north west);
    },
    overlay first={%
      % Draw clipped line for first part (assume at page top)
      \draw[black, line width=1pt]
        ([xshift=#1,yshift=-#2]frame.south west) -- 
        ([xshift=#1,yshift=#2]frame.north west);
    },
    overlay middle and last={%
      % Draw normal line for middle and last parts
      \draw[black, line width=1pt]
        ([xshift=#1,yshift=-#2]frame.south west) -- 
...
\NewDocumentEnvironment{ProofLineStrict}{O{0.5ex} O{0mm} O{-8.5ex} O{6ex}}{%
  \vspace{#3}% Configurable pre-spacing (default -8.5ex)
  \begin{list}{}{%
    \setlength{\leftmargin}{0.0em}%
    \setlength{\rightmargin}{0pt}%
  }%
  ...
  \tcolorbox[
    blanker,
    % No breakable - this is the "strict" version
    before skip=1ex,
    left=4mm, right=0mm, top=1mm, bottom=1mm,
    before upper=\indent,
    parbox=false,
    overlay={%
      % Single overlay for non-breakable box
      \draw[black, line width=1pt]
        ([xshift=#1,yshift=-#2]frame.south west) -- 
        ([xshift=#1,yshift=#2]frame.north west);
    }
  ]%
  \vspace{#4}% Configurable internal spacing (default 6ex)
}{%
  \endtcolorbox
  \end{list}%
}
...
% Make enumitem use circled labels
